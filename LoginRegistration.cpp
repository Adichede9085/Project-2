...
bool validpassword(string password) // function to check the validity of the password
{
    ...
    cout << "Note : your password length is less than 8 characters or more than 15 characters." << endl;
    return false;
}
void verificationcode() // verifying account
{
    ...
    cout << "We have sent a verification code to your email for confirming your account." << endl
